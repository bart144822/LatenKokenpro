...
<?php $query = "SELECT * FROM items WHERE restaurant_restaurant_id = 4 ";
$result = mysqli_query($db, $query);
if (!$result) { 
die("Database query failed.");
}
?>
<h1 align="center">The Red Dragon</h1>
<img src= "red.jpg" width=500 align="right"></img>
<div id="content">
<fieldset>
...
<br><br>
<a href="toevoegen.php?restaurant_restaurant_id='4'"."\"> Nieuw product toevoegen</a>
<?php //var_dump($_POST); ?>
<br><br>
</fieldset>
</from>

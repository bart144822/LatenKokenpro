...
<?php $query = "SELECT * FROM items WHERE restaurant_restaurant_id = 3 ";
$result = mysqli_query($db, $query);
if (!$result) { 
die("Database query failed.");
}
?>
<h1 align="center">Mona Lisa</h1>
<img src= "mona-lisa-restaurant.jpg" width=400 align="right"></img>
<div id="content">
<fieldset>
...
<br><br>
<a href="toevoegen.php?restaurant_restaurant_id='3'"."\"> Nieuw product toevoegen</a>
<?php //var_dump($_POST); ?>
<br><br>
</fieldset>
</from>
